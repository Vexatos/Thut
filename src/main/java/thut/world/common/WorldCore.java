...
public class WorldCore {
  ...
  void populateMap() {
    ...
    //White gives
    colourMap.put((short) (14 * 16), (byte) 6);
    colourMap.put((short) (15 * 16), (byte) 7);
    colourMap.put((short) (13 * 16), (byte) 5);
    colourMap.put((short) (11 * 16), (byte) 3);
    colourMap.put((short) (7 * 16), (byte) 8);
  ...
  public void registerLanguages() {
    ...
    for(String language : LANGUAGES_SUPPORTED) {
      ...
      if(!LanguageRegistry.instance().getStringLocalization("children", language).equals("")) {
        try {
          String[] children = LanguageRegistry.instance().getStringLocalization("children", language).split(",");

          for(String child : children) {
            if(!child.equals("") && child != null) {
  ...
  public void initHardens() {
    ...
    for(Block b : ThutBlocks.getAllBlocks()) {
      for(int meta = 0; meta < 16; meta++) {
        if(b != null && !oreDictName(b, meta).equals("Unknown")) {
