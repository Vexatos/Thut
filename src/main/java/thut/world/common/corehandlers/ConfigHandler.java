...
public class ConfigHandler {
  ...
  public ConfigHandler(File configFile) {
    ...
    try {
      ...
      TileEntityVolcano.minorExplosionRate = conf.get("Volcano Stuff", "Minor Explosion Rate", 4000, "the Average number of Volcano Ticks for a small explosion, no ash, small amounts of Lava")
          .getInt();
      ...
      Property chunksize = conf.get("Chunk Size", "chunksize", chunkSize,
